 ...
 */
public class GreaterThan<T extends Event> extends BinaryValueExpression<T,Number,Operator.Value> 
{
	public GreaterThan(ConcreteValue<T,Number> left, ConcreteValue<T,Number> right) 
	{
		super(left, right);
	}

	@Override
	public GreaterThan<T> copy(boolean with_tree) 
	{
		return new GreaterThan<T>(m_leftValue, m_rightValue);
	}
